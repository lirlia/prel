...
## [v0.8.8](https://github.com/lirlia/prel/compare/v0.8.7...v0.8.8) - 2026-06-21
...
- chore(deps): update songmu/tagpr action to v1.17.1 by @renovate[bot] in https://github.com/lirlia/prel/pull/291
- chore(deps): update dependency @types/jquery to v3.5.34 by @renovate[bot] in https://github.com/lirlia/prel/pull/290
- chore(deps): update postgres docker tag to v18.3 by @renovate[bot] in https://github.com/lirlia/prel/pull/292
- chore(deps): update actions/upload-artifact action to v7 by @renovate[bot] in https://github.com/lirlia/prel/pull/293
- chore(deps): update dependency @types/jquery to v4 by @renovate[bot] in https://github.com/lirlia/prel/pull/294
- chore(deps): update reviewdog/action-golangci-lint action to v2.10.0 by @renovate[bot] in https://github.com/lirlia/prel/pull/295
- chore(deps): update github-actions by @renovate[bot] in https://github.com/lirlia/prel/pull/296
- chore(deps): update songmu/tagpr action to v1.18.1 by @renovate[bot] in https://github.com/lirlia/prel/pull/298
- chore(deps): update npm by @renovate[bot] in https://github.com/lirlia/prel/pull/297
- chore(deps): update dependency prettier to v3.8.2 by @renovate[bot] in https://github.com/lirlia/prel/pull/299
- chore(deps): update github-actions by @renovate[bot] in https://github.com/lirlia/prel/pull/300
- chore(deps): update dependency prettier to v3.8.3 by @renovate[bot] in https://github.com/lirlia/prel/pull/301
- chore(deps): update songmu/tagpr action to v1.18.3 by @renovate[bot] in https://github.com/lirlia/prel/pull/302
- fix(deps): update dependency uuid to v14 by @renovate[bot] in https://github.com/lirlia/prel/pull/303
- chore(deps): update songmu/tagpr action to v1.19.0 by @renovate[bot] in https://github.com/lirlia/prel/pull/305
- chore(deps): update dependency @playwright/test to v1.60.0 by @renovate[bot] in https://github.com/lirlia/prel/pull/306
- chore(deps): update postgres docker tag to v18.4 by @renovate[bot] in https://github.com/lirlia/prel/pull/307
- chore(deps): update npm to v4.0.1 by @renovate[bot] in https://github.com/lirlia/prel/pull/308
- chore(deps): update github-actions to v1.20.0 by @renovate[bot] in https://github.com/lirlia/prel/pull/309
- chore(deps): update npm to v3.8.4 by @renovate[bot] in https://github.com/lirlia/prel/pull/310
- chore(deps): update npm by @renovate[bot] in https://github.com/lirlia/prel/pull/311
- chore(deps): update github-actions to v7 by @renovate[bot] in https://github.com/lirlia/prel/pull/312
