...
func encodeAPIIamRoleFilteringRulesGetResponse(response APIIamRoleFilteringRulesGetRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *APIIamRoleFilteringRulesGetOK:
...
func encodeAPIIamRoleFilteringRulesPostResponse(response APIIamRoleFilteringRulesPostRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *APIIamRoleFilteringRulesPostOK:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(200)
		span.SetStatus(codes.Ok, http.StatusText(200))
...
func encodeAPIIamRoleFilteringRulesRuleIDDeleteResponse(response APIIamRoleFilteringRulesRuleIDDeleteRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *APIIamRoleFilteringRulesRuleIDDeleteNoContent:
		w.WriteHeader(204)
...
func encodeAPISettingsPatchResponse(response APISettingsPatchRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *APISettingsPatchNoContent:
		w.WriteHeader(204)
		span.SetStatus(codes.Ok, http.StatusText(204))
...
func encodeAdminIamRoleFilteringGetResponse(response AdminIamRoleFilteringGetRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *AdminIamRoleFilteringGetOK:
		w.Header().Set("Content-Type", "text/html; charset=utf-8")
		w.WriteHeader(200)
		span.SetStatus(codes.Ok, http.StatusText(200))
...
func encodeAdminSettingGetResponse(response AdminSettingGetRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *AdminSettingGetOK:
		w.Header().Set("Content-Type", "text/html; charset=utf-8")
		w.WriteHeader(200)
		span.SetStatus(codes.Ok, http.StatusText(200))
